...
check_file "docker/compose/docker-compose.debug.yml" "Debug Docker Compose"
...
if [ $CHECKS_FAILED -eq 0 ]; then
    ...
    echo "   docker-compose -f docker-compose.yml -f docker/compose/docker-compose.debug.yml up --build"
    echo ""
