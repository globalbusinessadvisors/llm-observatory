...
check_file "docker/compose/docker-compose.app.yml" "Application Docker Compose"
check_file "docker/compose/docker-compose.dev.yml" "Development Docker Compose"
...
check_content "docker/compose/docker-compose.app.yml" "collector:" "Collector service defined"
check_content "docker/compose/docker-compose.app.yml" "storage:" "Storage service defined"
check_content "docker/compose/docker-compose.app.yml" "collector-dev:" "Dev collector service defined"

echo -e "\n${BLUE}Checking Port Configurations...${NC}"
check_content "docker/compose/docker-compose.app.yml" "4327" "Collector OTLP gRPC port"
check_content "docker/compose/docker-compose.app.yml" "4328" "Collector OTLP HTTP port"
check_content "docker/compose/docker-compose.app.yml" "9091" "Collector metrics port"
check_content "docker/compose/docker-compose.app.yml" "8082" "Collector health port"

echo -e "\n${BLUE}Checking LLM Processing Features...${NC}"
check_content "docker/compose/docker-compose.app.yml" "COLLECTOR_LLM_ENRICHMENT_ENABLED" "LLM enrichment config"
check_content "docker/compose/docker-compose.app.yml" "COLLECTOR_TOKEN_COUNTING_ENABLED" "Token counting config"
check_content "docker/compose/docker-compose.app.yml" "COLLECTOR_COST_CALCULATION_ENABLED" "Cost calculation config"

echo -e "\n${BLUE}Checking Health Checks...${NC}"
check_content "docker/compose/docker-compose.app.yml" "healthcheck:" "Health checks configured"
